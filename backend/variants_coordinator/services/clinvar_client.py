    ...
    async def annotate_variant(self, variant: Variant) -> Optional[VariantAnnotation]:
        ...
        try:
            ...
            return VariantAnnotation(
                variant_id=variant.variant_id, source="ClinVarAPI", **details
            )
        except httpx.HTTPStatusError as e:
            logger.warning(
                "ClinVar API request failed",
            ...
            logger.error(
                "Error annotating variant from ClinVar API",
                variant=variant.variant_id,
                error=str(e),
            )
            return None
