...
class ChartRequest(BaseModel):
    ...
    dimension: Optional[ChartDimension] = Field(
        None, description="Primary data dimension"
    )
    gene_list: Optional[List[str]] = Field(
        None, description="Specific genes to include"
    )
    populations: Optional[List[PopulationType]] = Field(
        None, description="Populations to compare"
    )
...
class ChartResponse(BaseModel):
    ...
    series: Optional[List[ChartSeries]] = Field(
        None, description="Data series for multi-series charts"
    )
...
class HeatmapData(BaseModel):
    ...
    color_scale: Optional[Dict[str, str]] = Field(
        None, description="Color scale configuration"
    )
...
class PopulationComparisonData(BaseModel):
    ...
    global_frequency: Optional[float] = Field(
        None, description="Global allele frequency"
    )
...
class CategoryDistribution(BaseModel):
    ...
    subcategories: Optional[Dict[str, int]] = Field(
        None, description="Subcategory breakdown"
    )
